...
class SongModel(models.Model):
    ...
    artist = models.ForeignKey(
        "Artist", on_delete=models.CASCADE, related_name="songs", db_index=True
    )
    ...
    lyrics = models.TextField(blank=True, null=True)  # NOSONAR
    track_number = models.PositiveIntegerField(
        blank=True, null=True, validators=[MinValueValidator(1), MaxValueValidator(200)]
    )
