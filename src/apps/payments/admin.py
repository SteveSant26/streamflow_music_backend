...
class InvoiceAdmin(admin.ModelAdmin):
    list_display = ['stripe_invoice_id', 'user', 'amount_display', 'status', 'paid_at', 'created_at']
...
class PaymentAdmin(admin.ModelAdmin):
    list_display = ['stripe_payment_intent_id', 'user', 'amount_display', 'status', 'created_at']
    list_filter = ['status', 'currency', 'created_at']
...
class CheckoutSessionAdmin(admin.ModelAdmin):
    list_display = ['stripe_session_id', 'user', 'plan', 'amount_display', 'status', 'created_at']
    list_filter = ['status', 'currency', 'created_at']
