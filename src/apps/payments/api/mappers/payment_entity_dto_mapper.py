from apps.payments.domain.entities import PaymentEntity, PaymentStatus
...
class PaymentEntityDTOMapper(
    AbstractEntityDtoMapper[PaymentEntity, PaymentResponseDTO]
):
    ...
    def entity_to_dto(self, entity: PaymentEntity) -> PaymentResponseDTO:
        """
    ...
    def dto_to_entity(self, dto: PaymentResponseDTO) -> PaymentEntity:
        """
