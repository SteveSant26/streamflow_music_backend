    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='billing_sessions', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(default='EUR', max_length=3)),
                ('status', models.CharField(choices=[('draft', 'Borrador'), ('open', 'Abierta'), ('paid', 'Pagada'), ('uncollectible', 'Incobrable'), ('void', 'Anulada')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.IntegerField(help_text='Monto en centavos')),
                ('currency', models.CharField(default='EUR', max_length=3)),
                ('status', models.CharField(choices=[('succeeded', 'Exitoso'), ('pending', 'Pendiente'), ('failed', 'Fallido'), ('canceled', 'Cancelado')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('active', 'Activa'), ('canceled', 'Cancelada'), ('incomplete', 'Incompleta'), ('incomplete_expired', 'Incompleta Expirada'), ('past_due', 'Vencida'), ('unpaid', 'Sin Pagar'), ('trialing', 'En Prueba')], max_length=20)),
