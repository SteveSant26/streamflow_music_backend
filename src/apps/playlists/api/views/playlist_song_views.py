...
class PlaylistSongViewSet(CRUDViewSetMixin):
    ...
    def list_songs(self, request, pk=None):
        ...
        self.logger.debug(f"playlist_id={pk}")
    ...
    def add_song(self, request, pk=None):
        ...
        self.logger.debug(f"add_song: playlist_id={pk}")
    ...
    def remove_song(self, request, pk=None, song_id=None):
        ...
        self.logger.debug(f"remove_song: playlist_id={pk}, song_id={song_id}")
