#!/usr/bin/env python3
"""
Script maestro para ejecutar todos los tests de Albums (Arquitectura Hexagonal)
"""
...
def run_test_file(test_file: str) -> tuple[bool, float]:
    ...
    try:
        ...
        result = subprocess.run(
            [sys.executable, os.path.join("test", "albums", test_file)],
            capture_output=True,
            text=True,
            encoding="utf-8",
            env=env,
...
def main():
    ...
    test_files = [
        ...
        "use_cases/test_album_use_cases.py",  # Tests de casos de uso
    ...
    # Resumen final
    print("\n" + "=" * 60)
    print("📊 RESUMEN FINAL DE TESTS - ALBUMS")
    print("=" * 60)
    ...
    if failed == 0:
        ...
        print("✨ El módulo Albums está completamente probado y funcional")
    else:
