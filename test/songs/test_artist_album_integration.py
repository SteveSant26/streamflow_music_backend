...
=======
        ...
        self.mock_album_repo.save.return_value = expected_album
        self.mock_album_repo.find_or_create_by_title_and_artist = AsyncMock(return_value=expected_album)
...
=======
    ...
    async def test_full_integration_flow(self):
        ...
        from apps.artists.infrastructure.repository.artist_repository import ArtistRepository
        from apps.albums.infrastructure.repository.album_repository import AlbumRepository
