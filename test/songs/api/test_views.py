...
class TestSongViewsConcepts(TestCase):
    ...
    def test_entity_to_dict_all_fields(self):
        ...
        expected_fields = [
            'id', 'title', 'artist_name', 'album_title', 'genre_name',
            'duration_seconds', 'file_url', 'thumbnail_url', 'tags',
            'play_count', 'favorite_count', 'download_count',
            'source_type', 'source_id', 'source_url',
            'is_explicit', 'is_premium', 'audio_quality',
            'created_at', 'last_played_at', 'release_date'
        ]
