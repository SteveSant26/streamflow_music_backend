...
class TestSearchSongs(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_search_songs_local_insufficient_search_youtube(self):
        ...
        self.mock_repository.search.return_value = local_results
        self.song_use_cases.music_service.search_and_process_music.return_value = youtube_tracks
    ...
    async def test_search_songs_existing_youtube_result(self):
        ...
        # Assert
        self.mock_repository.get_by_source.assert_called_with('youtube', 'youtube-search-123')
    ...
    async def test_search_songs_error_handling(self):
        ...
        self.song_use_cases.music_service.search_and_process_music.side_effect = Exception("YouTube API Error")
    ...
    async def test_search_songs_special_characters(self):
        ...
        # Arrange
        special_queries = ["rock & roll", "música clásica", "hip-hop/rap", "rock'n'roll"]
