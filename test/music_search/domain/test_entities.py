...
try:
    ...
    from src.apps.music_search.domain.interfaces import (
        YouTubeVideoInfo,
        MusicTrackData
    )
...
def test_search_response_entity_creation():
    ...
    albums = [
        SearchResultEntity('album', 'al1', 'Abbey Road', 'The Beatles', relevance_score=0.8)
    ]
    
    songs = [
        SearchResultEntity('song', 's1', 'Bohemian Rhapsody', 'Queen', relevance_score=0.95),
        SearchResultEntity('song', 's2', 'Come Together', 'The Beatles', relevance_score=0.88)
    ]
    
    genres = [
        SearchResultEntity('genre', 'g1', 'Rock', relevance_score=0.75)
    ]
