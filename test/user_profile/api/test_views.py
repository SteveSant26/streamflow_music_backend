...
class TestUserProfileAPI(TestCase):
    ...
    def test_create_user_profile(self):
        ...
        created_user = UserProfile.objects.get(email='new@example.com')
    ...
    def test_update_user_profile(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        updated_user = UserProfile.objects.get(id=self.user_id)
        self.assertEqual(updated_user.profile_picture, 'https://example.com/new_picture.jpg')
