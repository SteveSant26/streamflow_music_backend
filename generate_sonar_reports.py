...
def install_testing_dependencies():
    ...
    dependencies = ["pytest", "pytest-cov", "pytest-django", "coverage", "bandit"]
...
def run_bandit_security_scan():
    ...
    cmd = [
        ...
        "--skip",
        "B101,B601",  # Skipear asserts y shell=True en tests
    ]
...
def run_master_test_suite():
    ...
    try:
        result = subprocess.run(
            [sys.executable, "test/run_all_project_tests.py"],
            capture_output=True,
            text=True,
        )
...
def generate_sonar_report():
    ...
    report = {
        ...
        "coverage": {"format": "XML", "file": "test-reports/coverage.xml"},
        "security": {"format": "JSON", "file": "test-reports/bandit-report.json"},
        "notes": [
